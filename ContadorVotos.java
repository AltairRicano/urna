...
/**
 * Sistema de conteo de votos de urna electoral
 * Calcula el porcentaje de votos para cada candidato
 * 
 * @version 1.0
 * @since Java 25
 */
public class ContadorVotos {
     ...
     * @param numeroCandidato Número identificador del candidato
     */
    ...
    /**
     * Calcula y muestra los resultados del conteo
     */
    ...
    /**
     * Muestra una barra visual de progreso
     * @param porcentaje Porcentaje a representar
     */
    private void mostrarBarraProgreso(double porcentaje) {
        int barrasLlenas = (int) (porcentaje / 2); // Escala de 50 caracteres max
        String barra = "█".repeat(barrasLlenas) + "░".repeat(50 - barrasLlenas);
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            ...
            try {
                ...
                if (numeroCandidato < 0) {
                    System.out.println("⚠️  Error: El número debe ser positivo o 0 para finalizar.");
                    continue;
                }
